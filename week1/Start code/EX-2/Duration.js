...
/**
 * Returns a new Duration by decreasing another duration.
 * @param {Duration} other - Another duration to decrease 
 * @returns {Duration} A new Duration representing the result
 */
  minus = (other) => {
      return new Duration(this._totalSeconds - other._totalSeconds);
  };
